...
public class UsrDomainServiceIntegrationTest {

  @Autowired
  private UsrDominService usrDominService; // the test target Bean

  @Test
  public void testFindUserByUserId() {
    Usr actual = this.usrDominService.findUsrBySub("00u1sneigDs6Rolmu2p6");
