...
@Configuration
@ComponentScan("mrs.domain.services") // scan as specifically as possible
@EnableWebSecurity
  ...
  protected void configure(HttpSecurity http) throws Exception {
    http
        .authorizeRequests() // authorisation
          ...
          .antMatchers("/api/**").permitAll() // todo: PUT, DELTE are not allowed, fix
          .antMatchers("/miscellaneous/**").permitAll()
