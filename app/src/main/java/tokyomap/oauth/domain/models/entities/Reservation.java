...
public class Reservation implements Serializable {
  ...
  @ManyToOne
  @JoinColumns({@JoinColumn(name = "reserved_date"), @JoinColumn(name = "room_id")}) // the FK (reserved_date, room_id) references reservable_room(reserved_date, room_id)
  private ReservableRoom reservableRoom;

  @ManyToOne // a user can have some reservations, hence mapping here is many to one
  @JoinColumn(name = "user_id") // the FK user_id references user(user_id)
  private User user;
