...
import tokyomap.oauth.web.domain.services.reservation.AlreadyReservedException;
import tokyomap.oauth.web.domain.services.reservation.ReservationService;
import tokyomap.oauth.web.domain.services.reservation.UnavailableReservationException;
import tokyomap.oauth.web.domain.services.room.RoomService;
import tokyomap.oauth.web.domain.services.user.ReservationUserDetails;
...
@Controller
@RequestMapping("/web/reservations/{date}/{roomId}")
public class ReservationsController {
  ...
  public String cancel(
    ...
    return "redirect:/web/reservations/{date}/{roomId}";
  }
