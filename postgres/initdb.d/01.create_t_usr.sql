...
insert into
  t_usr (sub, name, family_name, given_name, middle_name, nickname, preferred_username, profile, picture, website, zoneinfo, locale, password, email, email_verified, address, phone, phone_number_verified, scopes, created_at, updated_at)
values
